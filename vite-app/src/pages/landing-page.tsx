...
export function LandingPage() {
  ...
  const androidDownloadUrl = 'https://play.google.com/store/apps/details?id=com.ghiz.bookscanner'
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-white dark:bg-gray-900">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Link to="/login">
                <Button variant="outline" className="border-[#38ada9] text-[#38ada9] hover:bg-[#38ada9] hover:text-white">
                  تسجيل الدخول
                </Button>
              </Link>
              <Link to="/login">
      ...
      <div className="container mx-auto px-4">
        ...
        <section className="py-20 md:py-32">
          <div className="max-w-5xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
              حل شامل لإدارة المكتبات باستخدام أحدث تقنيات الواقع المعزز والذكاء الاصطناعي. 
              زد من كفاءة عملياتك وحسّن تجربة المستخدمين.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
              <Link to="/login">
                <Button size="lg" className="text-lg px-8 h-12 bg-[#38ada9] hover:bg-[#2d8a86] text-white">
                  ابدأ الآن
                  <ArrowRight className="mr-2 h-5 w-5" />
                </Button>
              </Link>
              <Button size="lg" variant="outline" className="text-lg px-8 h-12 border-2 border-gray-300 dark:border-gray-700">
                طلب عرض توضيحي
              </Button>
            </div>
          </div>
        ...
        <section className="py-16 border-y bg-gray-50 dark:bg-gray-800/50">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">مكتبة نشطة</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-[#38ada9] mb-2">50K+</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">كتاب مُدار</div>
            </div>
            <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="border hover:border-[#38ada9] transition-all hover:shadow-lg">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl">اكتشاف بالواقع المعزز</CardTitle>
                  <CardDescription>
        ...
        {/* Solutions Section */}
        <section id="solutions" className="py-20 bg-gray-50 dark:bg-gray-800/50 scroll-mt-20">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="border-2 p-8">
                ...
                <CardContent className="p-0 space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700 dark:text-gray-300">إدارة آلاف الكتب بكفاءة</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-[#38ada9] mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700 dark:text-gray-300">تقارير وتحليلات متقدمة</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-[#38ada9] mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700 dark:text-gray-300">دعم متعدد المستخدمين</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 p-8">
                ...
                <CardContent className="p-0 space-y-3">
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-[#38ada9] mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700 dark:text-gray-300">سهولة الاستخدام والتركيب</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-[#38ada9] mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700 dark:text-gray-300">تكلفة منخفضة</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-[#38ada9] mt-0.5 flex-shrink-0" />
                    <span className="text-gray-700 dark:text-gray-300">دعم فني مخصص</span>
                  </div>
                </CardContent>
              </Card>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="flex flex-col items-center space-y-4">
                    <div className="bg-white p-4 rounded-xl shadow-lg">
                      <img 
                        src={`https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=${encodeURIComponent(qrCodeValue)}`}
                        alt="QR Code"
                        className="w-44 h-44"
                      />
                    </div>
        ...
        <section className="py-20">
          <div className="max-w-4xl mx-auto text-center space-y-8 bg-[#38ada9] rounded-2xl p-12 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/login">
                <Button size="lg" className="text-lg px-8 h-12 bg-white text-[#38ada9] hover:bg-white/90">
                  تسجيل الدخول
                  <ArrowRight className="mr-2 h-5 w-5" />
                </Button>
              </Link>
              <Button size="lg" variant="outline" className="text-lg px-8 h-12 border-2 border-white text-white hover:bg-white/10">
                طلب عرض توضيحي
              </Button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg font-bold text-gray-900 dark:text-white">نظام إدارة المكتبات</span>
              </div>
            ...
            <div>
              <h4 className="font-semibold mb-4 text-gray-900 dark:text-white">المنتج</h4>
            ...
            <div>
              <h4 className="font-semibold mb-4 text-gray-900 dark:text-white">الدعم</h4>
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                <li>مركز المساعدة</li>
                <li>التواصل معنا</li>
                <li>الدعم الفني</li>
            ...
            <div>
              <h4 className="font-semibold mb-4 text-gray-900 dark:text-white">الشركة</h4>
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                <li>من نحن</li>
                <li>المدونة</li>
                <li>الوظائف</li>
